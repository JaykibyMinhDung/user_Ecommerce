...
function Shop(props) {
	...
	useEffect(() => {
		const fetchAllData = async () => {
			...
			const totalPage = Math.ceil(
				parseInt(response.data.total) / parseInt(pagination.count)
			);
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			setTemp(response.data.categoryProducts);
		};
								...
								<div className='modal-body p-0'>
									<div className='row align-items-stretch'>
										<div className='col-lg-6 p-lg-0'>
											...
											/>
											<img className='d-none' href={value.image[1]} />
											<img className='d-none' href={value.image[2]} />
										</div>
										<div className='col-lg-6'>
